...
pub(crate) fn startup_keys() -> (Vec<PackageKey>, bool) {
...
pub(crate) fn management_package_roots() -> Vec<PathBuf> {
    vec![
...
pub(crate) fn scan_package_root(root: &Path, packages: &mut BTreeMap<String, PackageName>) -> bool {
...
pub(crate) fn reconciliation_keys(
    ordinary: &[PackageKey],
